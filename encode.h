...
typedef struct _EncodeInfo
{
    ...
    FILE *fptr_src_image; // file ptr or opening and closing img file
    uint image_capacity; // size of the img
    int img_file_size;	
    //uint bits_per_pixel;
    ...
    char extn_secret_file[5]; // store the extension in the string
    ...
    /* Stego Image Info */
    char *stego_image_fname; // op img file name 
    FILE *fptr_stego_image;  //file ptr to operate op img 
} EncodeInfo;
